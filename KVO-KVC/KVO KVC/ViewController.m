...
//    }
    ...
    NSLog(@"value for key `%@`: %@", keyPath, value);

    [object setValue:@(1) forKeyPath:keyPath];
    value = [object valueForKeyPath:keyPath];
    NSLog(@"value for key `%@`: %@", keyPath, value);
    
    keyPath = @"hrController.departments.employees.salary";
    value = [self valueForKeyPath:keyPath];
    NSLog(@"value for key `%@`: %@", keyPath, value);
    
    keyPath = @"hrController.departments.employees.@unionOfArrays.salary";
//    keyPath = @"hrController.departments.employees.@distinctUnionOfArrays.salary";
    value = [self valueForKeyPath:keyPath];
    NSLog(@"value for key `%@`: %@", keyPath, value);
    ...
    NSLog(@"Average Salaray: %@", [allEmployees valueForKeyPath:@"@avg.salary"]);
    NSLog(@"Max Salaray: %@", [allEmployees valueForKeyPath:@"@max.salary"]);
    NSLog(@"Min Salaray: %@", [allEmployees valueForKeyPath:@"@min.salary"]);
